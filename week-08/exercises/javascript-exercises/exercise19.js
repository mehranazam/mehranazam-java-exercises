...
function makeObject(str1, str2, str3) {
  let obj = {
    title: str1,
    firstName: str2,
    lastName: str3,
...
assert.deepStrictEqual(makeObject("", "Merilee", "Sheldrick"), {
  title: "",
  firstName: "Merilee",
  lastName: "Sheldrick",
});
assert.deepStrictEqual(makeObject("Mr.", "Bale", "Packmann"), {
  title: "Mr.",
  firstName: "Bale",
  lastName: "Packmann",
});
assert.deepStrictEqual(makeObject("Dr.", "Letisha", "Pursey"), {
  title: "Dr.",
  firstName: "Letisha",
  lastName: "Pursey",
});
