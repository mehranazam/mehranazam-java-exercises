...
drop database if exists university_mastery_test;

create database university_mastery_test;

use university_mastery_test;
...
begin
	...
	delete from course_students;  -- no autoincrement so don't need to truncate
    truncate grades;
    truncate courses;
